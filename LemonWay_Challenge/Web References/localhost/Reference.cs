...
namespace LemonWay_Challenge.localhost {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="WebServiceLemonwaySoap", Namespace="http://tempuri.org/")]
    public partial class WebServiceLemonway : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public WebServiceLemonway() {
            this.Url = global::LemonWay_Challenge.Properties.Settings.Default.LemonWay_Challenge_localhost_WebServiceLemonway;
        ...
        /// <remarks/>
        public void FibonacciAsync(int input) {
            this.FibonacciAsync(input, null);
        }
        
        /// <remarks/>
        public void FibonacciAsync(int input, object userState) {
            ...
            this.InvokeAsync("Fibonacci", new object[] {
                        input}, this.FibonacciOperationCompleted, userState);
        }
